"""In-memory implementation of the AbstractEventStore.
...
from forging_blocks.infrastructure.event_stores.abstract_event_store import (
    AbstractEventStore,
)


class InMemoryAbstractEventStore[EventPayloadType](AbstractEventStore[EventPayloadType]):
