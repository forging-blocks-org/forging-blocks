"""Abstract event store base class compliant with the application EventStorePort contract.

Defines the ``AbstractEventStore`` abstract interface for appending and retrieving
...
class AbstractEventStore[EventPayloadType](ABC):
