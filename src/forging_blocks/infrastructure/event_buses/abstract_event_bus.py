"""Abstract event bus base class compliant with the application EventBusPort contract.

Defines the ``AbstractEventBus`` abstract interface for in-process message dispatch
...
class AbstractEventBus[EventPayloadType, CommandPayloadType](ABC):
