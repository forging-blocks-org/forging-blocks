...
class LoggerPort[MessageType](OutboundPort[MessageType, None], Protocol):
    ...
    methods that accept a message of type ``MessageType`` plus optional
    positional arguments of the same type satisfies this protocol —
    ...
    def debug(self, msg: MessageType, *args: MessageType) -> None:
        """Log a debug message."""
        ...

    def info(self, msg: MessageType, *args: MessageType) -> None:
        """Log an info message."""
        ...

    def warning(self, msg: MessageType, *args: MessageType) -> None:
        """Log a warning message."""
        ...

    def error(self, msg: MessageType, *args: MessageType) -> None:
