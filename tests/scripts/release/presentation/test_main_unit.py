...
class TestMain:
    ...
    async def test_main_creates_container_and_initializes_it(self) -> None:
        ...
        with patch('scripts.release.presentation.__main__.Container') as mock_container_class, \
             patch('scripts.release.presentation.__main__.ReleaseCliParser') as mock_parser_class, \
             patch('scripts.release.presentation.__main__.ReleaseCliPresenter') as mock_presenter_class:
    ...
    def test_main_module_name_check_calls_asyncio_run(self) -> None:
        ...
        with patch('scripts.release.presentation.__main__.asyncio.run') as mock_asyncio_run, \
             patch('scripts.release.presentation.__main__.__name__', '__main__'):
